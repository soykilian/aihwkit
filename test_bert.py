...
def do_inference(model, trainer, squad, eval_data, writer, max_inference_time=1e6, n_times=9):
    ...
    #torch.save(f1_times, "/u/mvc/aihwkit/drift_compensation_NNs/bert_f1_baseline_1m_10y.th")
    #torch.save(exact_match_times, "/u/mvc/aihwkit/drift_compensation_NNs/bert_exact_match_baseline_1m_10y.th")
